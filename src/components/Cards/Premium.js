  ...
  return (
    <div className="Premium-card">
      <div className="Premium-details">
        <img
          className="juno-premium-card"
          src="https://juno-public.s3-us-west-1.amazonaws.com/Juno/juno-plus%403x.png"
          alt="juno-black-card"
        />
        <h2 className="heading">PREMIUM</h2>
        <p className="interest">
          1.65%<span className="text-super">2</span>
        </p>
        <p className="cashback">
          <span>4%</span>cash back
        </p>
      </div>
      <div className="Premium-signup">
        <div className="spots">
          <p className="spot-avail">2000 Spots</p>
          <p className="spot-left">2000 spots left</p>
        </div>
        <p className="line"></p>
        <button className="signup">Up Next</button>
      </div>
      <div className="Premium-banifits">
        ...
        <ul className="includes">
          ...
          <li>
            ...
            1.65%<span className="text-super">2</span> Bonus Rate Checking
            Account
          </li>
          <li>
            <span>
        ...
        <p className="details">
          ...
          <strong>$500</strong>. 2 additional free ATM withdrawals per month
      ...
      <div className="Premium-availability">
        ...
        <div className="Premium-membership">
          <p className="membership-fee">$6.99/m Membership Fee</p>
          <p className="saving">Comming Soom</p>
        </div>
      </div>
    </div>
  );
