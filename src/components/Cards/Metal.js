  ...
  return (
    <div className="metal-card">
      <div className="metal-details">
        <img
          className="juno-black-card"
          src="https://juno-public.s3-us-west-1.amazonaws.com/Juno/juno-black-card%403x.png"
          alt="juno-black-card"
        />
        <h2 className="heading">METAL</h2>
        <p className="interest">
          2.15%<span className="text-super">1</span>
        </p>
        <p className="cashback">
          <span>5%</span>cash back
        </p>
      </div>
      <div className="metal-signup">
        <div className="spots">
          <p className="spot-avail">
            <span>2290</span>/2500 Spots
          </p>
          <p className="spot-left">210 spots left</p>
        </div>
        <p className="line">
          <p></p>
        </p>
      ...
      <div className="metal-banifits">
        ...
        <ul className="includes">
          ...
          <li>
            ...
            2.15%<span className="text-super">1</span> Bonus Rate Checking
            Account
          </li>
          <li>
            <span>
        ...
        <p className="details">
          ...
          <strong>$1000</strong>. 3 additional free ATM withdrawals per month
          from out of network ATMs.
        </p>
      </div>
      <div className="metal-availability">
        <div className="icon">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="metal-membership">
          <p className="membership-fee">$11.99/m Membership Fee</p>
          <p className="free">Free for 6 months</p>
          <p className="saving">~$72 Savings</p>
        </div>
      </div>
    </div>
  );
